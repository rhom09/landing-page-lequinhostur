...
- [x] REQ-03: Limpeza de Bundle e Dívida Técnica (remover dependências de shadcn-ui não utilizadas e tipagens `any` do Sanity).
- [/] REQ-04: Estruturação para melhorias de SEO (Iniciando fase de análise).
...
---
*Última atualização: 11/05/2026 após conclusão da Fase 2*
